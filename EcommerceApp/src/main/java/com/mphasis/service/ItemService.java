...
public class ItemService implements ItemServiceInterface{
	...
	public Item findById(Long id) {
		return dao.findById(id).orElseThrow(()->new ItemNotFoundException("No Item is present with this id:"+id));
	}
	...
	public Item update(Item item,Long id) {
		Item exItem=dao.findById(id).orElseThrow(()->new ItemNotFoundException("No Item is present with this id:"+id));
